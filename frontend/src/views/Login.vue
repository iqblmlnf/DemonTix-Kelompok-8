  ...
  methods: {
    handleLogin() {
      if (!this.registeredUser) {
        alert("Anda belum memiliki akun. Silakan Sign Up terlebih dahulu.");
        this.isSignUp = true;
        return;
      }

      if (
        this.loginUsername === this.registeredUser.username &&
        this.loginPassword === this.registeredUser.password
      ) {
    ...
    handleSignUp() {
      if (this.signupUsername && this.signupEmail && this.signupPassword) {
        ...
        alert("Sign up berhasil! Silakan login menggunakan akun Anda.");
        this.signupUsername = "";
        this.signupEmail = "";
        this.signupPassword = "";
        this.isSignUp = false;
